...
public class DEPirateShip extends DEShipStructure {
    ...
    public DEPirateShip() {super(DEConfig.COMMON.pirate_ship, true, true, (context -> DETerrainAnalyzer.areNearbyBiomesValid(context.biomeSource(), context.chunkPos(), context.chunkGenerator(), 16, context.validBiome())), DEPirateShip::assembleShip, DEUtil.pieceBuilder().offset(-7, -3, -25).add("pirate_ship/front").build());}
