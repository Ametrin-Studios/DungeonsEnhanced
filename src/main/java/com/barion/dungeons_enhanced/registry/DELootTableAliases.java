...
public final class DELootTableAliases {
    ...
    private static void register(RegisterHelper<ResourceKey<LootTable>> event) {
        // Vanilla
        event.register(Identifier.withDefaultNamespace("desert_pyramid"), BuiltInLootTables.DESERT_PYRAMID);
//        event.register(Identifier.withDefaultNamespace("simple_dungeon"), BuiltInLootTables.SIMPLE_DUNGEON);
        event.register(Identifier.withDefaultNamespace("village/house/desert"), BuiltInLootTables.VILLAGE_DESERT_HOUSE);
        event.register(Identifier.withDefaultNamespace("village/house/plains"), BuiltInLootTables.VILLAGE_PLAINS_HOUSE);
        event.register(Identifier.withDefaultNamespace("village/house/savanna"), BuiltInLootTables.VILLAGE_SAVANNA_HOUSE);
        event.register(Identifier.withDefaultNamespace("village/house/snowy"), BuiltInLootTables.VILLAGE_SNOWY_HOUSE);
        event.register(Identifier.withDefaultNamespace("village/house/taiga"), BuiltInLootTables.VILLAGE_TAIGA_HOUSE);

        // NOTE: might make sense to use the same name for the alias as the actual loot table
        // Overworld

        event.register(DELootTables.Castle.ARMORY.identifier(), DELootTables.Castle.ARMORY);
        event.register(DELootTables.Castle.BEDROOM.identifier(), DELootTables.Castle.BEDROOM);
        event.register(DELootTables.Castle.CELLAR.identifier(), DELootTables.Castle.CELLAR);
        event.register(DELootTables.Castle.COFFIN.identifier(), DELootTables.Castle.COFFIN);
        event.register(DELootTables.Castle.KITCHEN.identifier(), DELootTables.Castle.KITCHEN);
        event.register(DELootTables.Castle.LIBRARY.identifier(), DELootTables.Castle.LIBRARY);
        event.register(DELootTables.Castle.PRISON.identifier(), DELootTables.Castle.PRISON);
        event.register(DELootTables.Castle.QUARTERS.identifier(), DELootTables.Castle.QUARTERS);
        event.register(DELootTables.Castle.SPRING.identifier(), DELootTables.Castle.SPRING);
        event.register(DELootTables.Castle.THRONE.identifier(), DELootTables.Castle.THRONE);
