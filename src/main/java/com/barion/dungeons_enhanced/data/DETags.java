...
public final class DETags {
    public interface Items {
        private static TagKey<Item> create(String name) { return TagKey.create(Registries.ITEM, DEUtil.locate(name)); }
    }
    ...
    public interface Biomes {
        ...
        private static TagKey<Biome> create(String name) { return TagKey.create(Registries.BIOME, DEUtil.locate(name)); }
    }
    ...
    public interface Structures{
        ...
        private static TagKey<Structure> create(String name) { return TagKey.create(Registries.STRUCTURE, DEUtil.locate(name)); }
    }
}
