...
public class DETags {
    public interface Items {
        private static TagKey<Item> create(String name) { return TagKey.create(Registries.ITEM, DEUtil.location(name));}
    }
    ...
    public interface Structures{
        ...
        private static TagKey<Structure> create(String name) {return TagKey.create(Registries.STRUCTURE, DEUtil.location(name));}
    }
}
