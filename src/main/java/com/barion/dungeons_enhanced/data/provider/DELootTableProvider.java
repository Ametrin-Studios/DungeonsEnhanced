...
public final class DELootTableProvider extends LootTableProvider {
    ...
    public static final class DEStructureLootTables implements LootTableSubProvider {
        ...
        public void generate(@Nonnull BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
            {
                consumer.accept(locate("castle/armory"), LootTable.lootTable()
                ...
                consumer.accept(locate("castle/bedroom"), LootTable.lootTable()
                ...
                consumer.accept(locate("castle/cellar"), LootTable.lootTable()
                ...
                consumer.accept(locate("castle/coffin"), LootTable.lootTable()
                        .withPool(pool(number(8, 17))
                ...
                consumer.accept(locate("castle/kitchen"), LootTable.lootTable()
                ...
                consumer.accept(locate("castle/library"), LootTable.lootTable()
                        ...
                        .withPool(pool(number(1, 3))
                                .add(enchantedItem(Items.BOOK, 1, number(20, 25)))));

                consumer.accept(locate("castle/prison"), LootTable.lootTable()
                ...
                consumer.accept(locate("castle/quarters"), LootTable.lootTable()
                        .withPool(pool(number(7, 15))
                ...
                consumer.accept(locate("castle/spring"), LootTable.lootTable()
...
//                                .add(tag(DETags.Items.CASTLE_TREASURE, 1))
                ...
                consumer.accept(locate("castle/throne"), LootTable.lootTable()
...
//                                .add(tag(DETags.Items.CASTLE_TREASURE, 2))
                                                .add(enchantedItem(Items.DIAMOND_SWORD, 4, number(4, 12)))
                                                .add(enchantedItem(Items.DIAMOND_AXE, 4, number(4, 12)))
                                                .add(enchantedItem(Items.DIAMOND_HELMET, 4, number(4, 10)))
                                                .add(enchantedItem(Items.DIAMOND_CHESTPLATE, 3, number(3, 10)))
                                                .add(enchantedItem(Items.DIAMOND_LEGGINGS, 3, number(3, 10)))
                                                .add(enchantedItem(Items.DIAMOND_BOOTS, 4, number(3, 10)))
                                )
                );
            } // Castle
            {
                consumer.accept(locate("deep_crypt"), LootTable.lootTable()
                        .withPool(pool(number(8, 13))
                                ...
                                .add(enchantedItem(Items.BOOK, 2, number(1, 2)))
            ...
            {
                consumer.accept(locate("desert_tomb"), LootTable.lootTable()
                        ...
                        .withPool(pool(number(0, 1))
                                .add(enchantedItem(Items.BOOK, 1, number(5, 18)))
                                .add(enchantedItem(Items.GOLDEN_SWORD, 1, number(0, 7)))
                                .add(enchantedItem(Items.GOLDEN_PICKAXE, 1, number(0, 7)))
                                .add(enchantedItem(Items.GOLDEN_AXE, 1, number(0, 7)))
                                .add(enchantedItem(Items.GOLDEN_HELMET, 1, number(0, 7)))
                                .add(enchantedItem(Items.GOLDEN_CHESTPLATE, 1, number(0, 7)))
                                .add(enchantedItem(Items.GOLDEN_LEGGINGS, 1, number(0, 7)))
                                .add(enchantedItem(Items.GOLDEN_BOOTS, 1, number(0, 7)))
                        ));
            } // Desert Tomb
            {
                consumer.accept(locate("elders_temple/main"), LootTable.lootTable()
                        .withPool(pool(number(8, 16))
                                ...
                                .add(item(Items.SCUTE, 1, number(0, 1)))
                ...
                consumer.accept(locate("elders_temple/elder_room"), LootTable.lootTable()
                        .withPool(pool(number(8, 16))
                                .add(item(Items.NAUTILUS_SHELL, 2, number(0, 1)))
            ...
            {
                consumer.accept(locate("fishing_ship"), LootTable.lootTable()
                        .withPool(pool(number(8, 16))
                                .add(item(Items.COD, 3))
                                .add(item(Items.SALMON, 3))
                                .add(item(Items.COD_BUCKET, 1))
                                .add(item(Items.SALMON_BUCKET, 1))
            ...
            } // Fishing Ship
            {
                consumer.accept(locate("flying_dutchman"), LootTable.lootTable()
                        .withPool(pool(number(7, 9))
                                ...
                                .add(enchantedItem(Items.BOOK, 1, number(6, 14)))
            ...
            {
                consumer.accept(locate("large_dungeon"), LootTable.lootTable()
                        .withPool(pool(number(8, 14))
                                .add(item(Items.IRON_INGOT, 3))
                        ...
                        .withPool(pool(number(0, 2))
                                ...
                                .add(enchantedItem(Items.IRON_HELMET, 2, number(4, 12)))
                                .add(enchantedItem(Items.IRON_CHESTPLATE, 2, number(4, 12)))
                                .add(enchantedItem(Items.IRON_LEGGINGS, 2, number(4, 12)))
                                .add(enchantedItem(Items.IRON_BOOTS, 2, number(4, 12)))
            ...
            {
                consumer.accept(locate("monster_maze/church"), LootTable.lootTable()
                ...
                consumer.accept(locate("monster_maze/treasure"), LootTable.lootTable()
                        ...
                        .withPool(pool(number(4, 6))
                                ...
                                .add(enchantedItem(Items.BOOK, 2, number(10, 22)))
                                .add(enchantedItem(Items.BOW, 1, number(0, 12)))
                                .add(enchantedItem(Items.CROSSBOW, 1, number(0, 12)))
                                .add(enchantedItem(Items.DIAMOND_HELMET, 1, number(0, 12)))
                                .add(enchantedItem(Items.DIAMOND_CHESTPLATE, 1, number(0, 12)))
                                .add(enchantedItem(Items.DIAMOND_LEGGINGS, 1, number(0, 12)))
                                .add(enchantedItem(Items.DIAMOND_BOOTS, 1, number(0, 12))))
                        .withPool(pool(number(0, 1))
                ...
                consumer.accept(locate("monster_maze/prison"), LootTable.lootTable()
                        .withPool(pool(number(10, 16))
                                .add(item(Items.PAPER, 2))
                                .add(item(Items.CHAIN, 2))
                                .add(item(Items.ROTTEN_FLESH, 3))
                                .add(item(Items.POTATO, 2))
                                .add(item(Items.POISONOUS_POTATO, 2))
                                .add(item(Items.STRING, 2))
                                .add(item(Items.BONE, 3))
                                .add(item(Items.MAP, 1))
                                .add(item(Items.LEAD, 1))
                                .add(item(Items.MUSHROOM_STEW, 1))
                                .add(item(Items.CANDLE, 1))
                                .add(suspiciousStew(2))
                                .add(item(Items.BOWL, 2))
                                .add(potion(1, Potions.WEAKNESS, number(0, 1)))
                                .add(potion(1, Potions.STRENGTH, number(0, 1))))
                        .withPool(pool(number(0, 1))
                                .add(enchantedItem(Items.STONE_PICKAXE, 4, number(5, 10)))
                                .add(enchantedItem(Items.GOLDEN_PICKAXE, 3, number(4, 9)))
                                .add(enchantedItem(Items.IRON_PICKAXE, 2, number(3, 8)))
                                .add(enchantedItem(Items.DIAMOND_PICKAXE, 1, number(2, 7))))
                        .withPool(pool(number(0, 2))
                ...
                consumer.accept(locate("monster_maze/brewery"), LootTable.lootTable()
            ...
            {
                consumer.accept(locate("pirate_ship"), LootTable.lootTable()
                        .withPool(pool(number(8, 16))
                                .add(item(Items.COD, 3))
                                .add(item(Items.SALMON, 3))
                                .add(item(Items.STRING, 4))
            ...
            {
                consumer.accept(locate("ruined_building"), LootTable.lootTable()
            ...
            {
                consumer.accept(locate("tree_house/roof"), LootTable.lootTable()
            ...
            {
                consumer.accept(locate("tower_of_the_undead/treasure"), LootTable.lootTable()
                        ...
                        .withPool(pool(number(1, 3))
                                ...
                                .add(item(Items.IRON_CHESTPLATE, 1))
                                .add(item(Items.IRON_LEGGINGS, 1))
                                .add(enchantedItem(Items.BOOK, 1, number(4, 10)))
                                .add(item(Items.IRON_BOOTS, 1))
                        ));
            } // Tower of the Undead
            {
            ...
            {
                consumer.accept(locate("watch_tower"), LootTable.lootTable()
            ...
            {
                consumer.accept(locate("witch_tower"), LootTable.lootTable()
                        ...
                        .withPool(pool(number(2, 4))
                                ...
                                .add(item(Items.NAME_TAG, 1))
                                .add(item(Items.GOLDEN_APPLE, 1))
                                .add(enchantedItem(Items.BOOK, 1, number(6, 13)))));
            } // Witch Tower
        }

        private static void MinersHouseLoot(@Nonnull BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
