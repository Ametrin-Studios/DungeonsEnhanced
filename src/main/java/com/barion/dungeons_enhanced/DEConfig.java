...
public final class DEConfig {
    ...
    public static class Common {
        protected Common(ModConfigSpec.Builder builder) {
            // Overworld
            structureBiomes(DEStructures.CASTLE).whitelist(Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_SNOWY).blacklist(Tags.Biomes.IS_OCEAN, Tags.Biomes.IS_RIVER, DETags.Biomes.IS_SHORE).popBiomes().build(builder);
            ...
            tagsStructure(builder, DEStructures.FLYING_DUTCHMAN, Tags.Biomes.IS_OCEAN, Tags.Biomes.IS_RIVER);
            ...
            structureBiomes(DEStructures.ICE_PIT).whitelist(Tags.Biomes.IS_SNOWY).blacklist(Tags.Biomes.IS_OCEAN, Tags.Biomes.IS_RIVER, Tags.Biomes.IS_MOUNTAIN, DETags.Biomes.IS_SHORE).popBiomes().build(builder);
            tagsStructure(builder, DEStructures.JUNGLE_MONUMENT, BiomeTags.HAS_JUNGLE_TEMPLE);
            structureBiomes(DEStructures.LARGE_DUNGEON).whitelist(Tags.Biomes.IS_PLAINS, BiomeTags.IS_FOREST, BiomeTags.IS_TAIGA).blacklist(DETags.Biomes.IS_BAD_FOR_STRUCTURE, Tags.Biomes.IS_OCEAN, Tags.Biomes.IS_RIVER).popBiomes().build(builder);
            ...
            structureBiomes(DEStructures.RUINED_BUILDING).whitelist(Tags.Biomes.IS_PLAINS, BiomeTags.IS_FOREST, BiomeTags.IS_TAIGA).blacklist(DETags.Biomes.IS_BAD_FOR_STRUCTURE, Tags.Biomes.IS_OCEAN, Tags.Biomes.IS_RIVER).popBiomes().build(builder);
            structureBiomes(DEStructures.STABLES).whitelist(Tags.Biomes.IS_PLAINS, BiomeTags.IS_FOREST).blacklist(DETags.Biomes.IS_BAD_FOR_STRUCTURE, Tags.Biomes.IS_OCEAN, Tags.Biomes.IS_RIVER).blacklist(Biomes.DARK_FOREST).popBiomes().build(builder);
            ...
            overworldExceptStructure(builder, DEStructures.TOWER_OF_THE_UNDEAD, Tags.Biomes.IS_SANDY, Tags.Biomes.IS_OCEAN, Tags.Biomes.IS_RIVER, BiomeTags.IS_JUNGLE, DETags.Biomes.IS_BAD_FOR_STRUCTURE, BiomeTags.IS_BADLANDS);
        ...
        private static void tagsNoWaterStructure(ModConfigSpec.Builder builder, StructureRegistrar<? extends Structure> structure, TagKey<Biome>... tagKeys) {
            structureBiomes(structure).whitelist(tagKeys).blacklist(Tags.Biomes.IS_OCEAN, Tags.Biomes.IS_RIVER).popBiomes().build(builder);
        }
