...
public class DEConfig {
    ...
    public static class Common{
        ...
        protected Common(ForgeConfigSpec.Builder builder) {
            ...
            Castle = configs("castle", 56, 42, Level.OVERWORLD, "#minecraft:is_taiga");
            ...
            DruidCircle = configs("druid_circle", 39, 40, Level.OVERWORLD, "#minecraft:is_overworld" );
            ...
            IcePit = configs("ice_pit", 35, 70, Level.OVERWORLD, "#forge:is_snowy");
            JungleMonument = configs("jungle_monument", 41, 75, Level.OVERWORLD, "#minecraft:is_jungle");
            LargeDungeon = configs("large_dungeon", 39, 35, Level.OVERWORLD, "#minecraft:is_overworld");
            MinersHouse = configs("miners_mouse", 24, 80, Level.OVERWORLD, "#minecraft:is_badlands");
            MonsterMaze = configs("monster_maze", 34, 50, Level.OVERWORLD, "#forge:is_spooky");
            MushroomHouse = configs("mushroom_house", 15, 75, Level.OVERWORLD, "minecraft:mushroom_fields", "minecraft:mushroom_field_shore");
            PillagerCamp = configs("pillager_camp", 49, 35, Level.OVERWORLD, "#minecraft:is_overworld");
            PirateShip = configs("pirate_ship", 65, 49, Level.OVERWORLD, "#minecraft:is_ocean");
            RuinedBuilding = configs("ruined_building", 27, 45, Level.OVERWORLD, "#minecraft:is_overworld");
            Stables = configs("stables", 46, 32, Level.OVERWORLD, "#minecraft:is_overworld");
            ...
            TowerOfTheUndead = configs("tower_of_the_undead", 37, 35, Level.OVERWORLD, "#minecraft:is_overworld");
            TreeHouse = configs("tree_house", 29, 40, Level.OVERWORLD, "#minecraft:is_jungle");
            WatchTower = configs("watch_tower", 33, 45, Level.OVERWORLD, "#forge:is_cold");
